...
const (
	...
	editTitle                    // editing chapter title
	editSummary                  // editing chapter summary
)
...
func (m *outlineEditorModel) View() string {
	...
	footer := renderHintBar(OutlineEditorBindings)
	if m.dirty {
